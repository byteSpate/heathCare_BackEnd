...
const createIntoDB = (0, catchAsync_1.catchAsync)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const user = req.user;
    const result = yield prescription_service_1.prescriptionServices.createIntoDB(user, req.body);
...
const getMyPrescription = (0, catchAsync_1.catchAsync)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const user = req.user;
    const options = (0, pick_1.default)(req.query, ["page", "limit", "sortBy", "sortOrder"]);
    const result = yield prescription_service_1.prescriptionServices.getMyPrescription(user, options);
    (0, sendResponse_1.sendResponse)(res, {
        statusCode: 200,
        success: true,
