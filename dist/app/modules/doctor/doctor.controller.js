...
const getAllFromDB = (0, catchAsync_1.catchAsync)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const query = (0, pick_1.default)(req.query, doctor_constant_1.doctorFilterAbleSearchFields);
    const options = (0, pick_1.default)(req.query, ["page", "limit", "sortBy", "sortOrder"]);
    const result = yield doctor_service_1.doctorService.getAllFromDB(query, options);
...
const updateIntoDB = (0, catchAsync_1.catchAsync)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    const data = req.body;
    const result = yield doctor_service_1.doctorService.updateIntoDB(id, data);
    (0, sendResponse_1.sendResponse)(res, {
        statusCode: 200,
        success: true,
