...
-- AddForeignKey
ALTER TABLE "appointments" ADD CONSTRAINT "appointments_docotorId_fkey" FOREIGN KEY ("docotorId") REFERENCES "doctors"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
